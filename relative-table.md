...
| $$\mathrm{SO}_3^{\times 3}$$ | $$\mathrm{SO}_3^{\times 3}/\mathrm{SO}_3^\mathrm{diag}$$ | $$\mathrm{SL}_2^{\times 3}$$ | $$u\in \mathrm{Hom}(\mathbf{A}^2, (\mathbf{A}^2)^{\otimes 2})$$ such that $$I + \beta u u^\ast$$ is invertible | <a href = "https://annals.math.princeton.edu/wp-content/uploads/annals-v159-n1-p03.pdf">Bhargava cubes</a> (see <a href = "https://sanathdevalapurkar.github.io/files/PGL2-cubes.pdf">here</a> for elaboration) |
