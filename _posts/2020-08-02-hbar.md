...
quantized algebras can be viewed as the Dyer-Lashof operation $$Q_1$$. I haven't
tried to prove something like the Azumaya algebra property from Proposition 1.24
(see also Lemma 3.2) of their paper, but it should certainly be doable
(although, as far as I understand, their techniques don't really generalize to
